...
mean_intens <- objectData %>% 
  ...
  summarise(nCells = n(),
            Mean = mean(Intensity_MeanIntensity_Cy5),
            MeanSD = sd(Intensity_MeanIntensity_Cy5),
            IntDen = mean(Intensity_IntegratedIntensity_Cy5),
            IntDenSD = sd(Intensity_IntegratedIntensity_Cy5))
